...
public final class Messages extends NLS {
	...
	public static String WSO2_ANALYTICS_VERSION;
	public static String WSO2_ANALYTICS_STREAM_VERSION;
	public static String WSO2_ANALYTICS_PUBLISHER_VERSION;
	public static String WSO2_ANALYTICS_RECEIVER_VERSION;
	public static String WSO2_ANALYTICS_EXECUTIONPLAN_VERSION;
	...
	public static String WSO2_ESB_INBOUND_ENDPOINT_VERSION;
	public static String WSO2_GENERAL_PROJECT_VERSION;
	public static String WSO2_QOS_PROJECT_VERSION;
