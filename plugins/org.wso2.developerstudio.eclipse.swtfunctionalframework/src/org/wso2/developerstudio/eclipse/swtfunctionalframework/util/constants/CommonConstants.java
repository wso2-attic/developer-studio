...
public class CommonConstants {
    ...
    public static final String DEVELOPER_STUDIO_DASHBOARD = "Developer Studio Dashboard";
    ...
    public static final String SPECIFY_PARENT_FROM_WORKSPACE = "Specify Parent from Workspace";
    public static final String SQL = ".sql";
    public static final String USE_DEFAULT_LOCATION = "Use Default Location";
