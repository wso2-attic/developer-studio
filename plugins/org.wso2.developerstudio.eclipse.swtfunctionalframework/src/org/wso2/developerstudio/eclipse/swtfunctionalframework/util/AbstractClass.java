...
public class AbstractClass extends Util {
    ...
    public static void validateProxyServicexml(String proxyService) {
        ...
        try {
            ...
            System.out.println("Validation failiure");
            fail();
        }
    }
    ...
    public static void validateJavaClass(String packageName, String className) {
        ...
        System.out.println("Validation sucsessful");
    }

    public static void validateJAxis2ServiceClass(String packageName, String className) {
    ...
    public static void createGadgetProject(String projectName) {
        ...
        try {
            ...
            System.out.println("Create Gadget Project was sucsessful");
        } catch (Exception e) {
            System.out.println("Create Gadget Project was unsucsessful");
            fail();
        }
    }
    ...
    public static void createNewBPELProject(String projectName) {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Create New BPEL Project Sucsessful");
            } catch (WidgetNotFoundException e) {
                System.out.println("Editor didnt load");
                fail();
            }
        } catch (Exception e) {
            System.out.println("Create New BPEL Project unsucsessful");
        }
    ...
    public static void changePerspective() {
        try {
            ...
            System.out.println("Project unsucsessful");
            fail();
        }
    }
    ...
    public static void createSqlFile(String filename) {
        ...
        try {
            ...
            System.out.println("Create Sql File Sucsessful");
        } catch (WidgetNotFoundException e) {
            System.out.println("Editor didnt load");
            fail();
        }
    ...
    public static void openPerspective(String perspective) {
        try {
            ...
            System.out.println("Widget cannot be load");
            fail();
        }
    }
    ...
    public static void appFactoryLogin(String emailUserName, String domainName, String password) {
        ...
        try {
            ...
            System.out.println("Problem with the login widget");
            fail();
        }
    ...
    public static void deleteWithContent(String projectName) {
        ...
        try {
            ...
            System.out.println("Delete unsucsessful");
            fail();
        }
    }
    ...
    public static SWTBotTreeItem packageExplorer(String projectName, String packageName) {
        try {
            ...
            System.out.println("Tree selection sucsessful");
            return bot.tree().getTreeItem(projectName).getNode("src/main/java").getNode(packageName);
        } catch (Exception e) {
            System.out.println("Problem with tree selection");
            fail();
            return null;
        }
    }
    ...
    public static void activateCtab(String tabName) {
        try {
            ...
            System.out.println("Ctab cannot be found");
            fail();
        }
    }
