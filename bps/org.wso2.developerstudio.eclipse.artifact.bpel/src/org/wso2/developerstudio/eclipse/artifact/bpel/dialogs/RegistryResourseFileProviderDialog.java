...
/**
 * This class can be used to provide a dialog box to select resource files from the workspace for BPEL artifacts
 */
public class RegistryResourseFileProviderDialog extends DeveloperStudioElementProviderDialog {

	public RegistryResourseFileProviderDialog(Shell parentShell, Class<?>[] type,
			Map<String, List<String>> filters) {
		super(parentShell, type, filters);
	}

	/**
	 * This method is used to provide registry file list in the workspace
	 * 
	 * @return List<Object>
	 */
	@Override
