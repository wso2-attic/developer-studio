...
public class RegistryResourceBrowserDialog extends Dialog {
	...
	public RegistryResourceBrowserDialog(Shell parent, int style,
			java.util.List<NamedEntityDescriptor> localNamedEntities, Text txtPolicyFile) {
		super(parent);
		// this.rkProperty = property;
		this.txtPolicyFile = txtPolicyFile;
	...
	private void loadConfiguration() {
		if (!StringUtils.isBlank(txtPolicyFile.getText())) {
			rkTextField.setText(txtPolicyFile.getText());
		}
	}
	...
	private void saveConfiguration() {
		txtPolicyFile.setText(rkTextField.getText());
		path = txtPolicyFile.getText();
